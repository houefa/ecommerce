 ...
 */
class Unitemesure extends \EcommerceBundle\Entity\Unitemesure implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EcommerceBundle\\Entity\\Unitemesure' . "\0" . 'id', '' . "\0" . 'EcommerceBundle\\Entity\\Unitemesure' . "\0" . 'libelle', '' . "\0" . 'EcommerceBundle\\Entity\\Unitemesure' . "\0" . 'produit', '' . "\0" . 'EcommerceBundle\\Entity\\Unitemesure' . "\0" . 'creepar', '' . "\0" . 'EcommerceBundle\\Entity\\Unitemesure' . "\0" . 'creele', '' . "\0" . 'EcommerceBundle\\Entity\\Unitemesure' . "\0" . 'modifiele'];
        }
